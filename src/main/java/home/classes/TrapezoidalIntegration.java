...
public class TrapezoidalIntegration extends Integration {
    ...
    public double calculateTrapezoid(String function, String min, String max, String plot_interval, String segments) throws MatlabExecutionException, MatlabSyntaxException {
        try {
            ...
            String integrationScript = "f = @(x) " + integral_expr + "; a = " + min + "; b = " + max + "; n = " + segments + "; h = (b-a)/n;" +
                    ...
                    "xlabel('x'); ylabel('y'); title('Integration with Plot'); grid on;" +
